...
if __name__ == '__main__':
    ...
    corpus_names = ['multiun','opener','europarl']

    for corpus_name in corpus_names:
        corpus_dir_list = 'opinionfinderv2.0/database/docs/'+corpus_name
        sents = MySentences(corpus_dir_list)
        out_dir = 'LanguageModels/'+corpus_name + '/model1'
